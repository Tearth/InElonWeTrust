    ...
    public class CommonBotListsService
    {
        ...
        public CommonBotListsService()
        {
            _botListDefinitions = new List<BotListUpdater>
            {
                ...
                //new BotListUpdater("https://discordbotlist.com/api/bots/{0}/stats", "guilds", SettingsLoader.Data.DiscordBotListToken),
                //new BotListUpdater("https://bots.ondiscord.xyz/bot-api/{0}/guilds", "guildCount", SettingsLoader.Data.BotsOnDiscordToken),
